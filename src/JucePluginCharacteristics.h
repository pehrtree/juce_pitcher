...
*/
#define JucePlugin_Name                     "Juce Pitcher"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "Pitch Bending using JUCE and VST"

/** The name of your company. (Try to keep this as short as possible)
*/
#define JucePlugin_Manufacturer             "PehrTree Productions"

/** A four-character code for your company.
    Use single quotes - this isn't a string!
*/
#define JucePlugin_ManufacturerCode         'PTP!'
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'JPch'
...
*/
#define JucePlugin_CFBundleIdentifier       "com.PehrTreeProductions.JucePitcher"
